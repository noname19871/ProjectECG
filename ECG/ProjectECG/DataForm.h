...
#pragma region Windows Form Designer generated code
	protected:
		...
		virtual void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(434, 15);
...
#pragma endregion
	...
	private: System::Void ReadyButton_Click(System::Object^  sender, System::EventArgs^  e) {
		SaveWavesToFile(ParseDatasIntoDoubleVector(this->HeightsPanel, 5), "data.csv", "Height");
		SaveWavesToFile(ParseDatasIntoDoubleVector(this->LengthsPanel, 5), "data.csv", "Length");
		SaveWavesToFile(ParseDatasIntoDoubleVector(this->PosesPanel, 5), "data.csv", "Poses");
